...
class AddNoteActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        addNoteBackground = findViewById(R.id.dashboard)
        ...
        val addNoteName = findViewById<TextView>(R.id.add_note_name)
        ...
        addNoteButton.setOnClickListener {
            ...
            val data = Intent()
            data.putExtra("note_name", addNoteName.text.toString())
